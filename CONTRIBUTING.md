...
Thank you for contributing to phpstorm-inspect!
...
- The build of your branch on [Travis CI](https://travis-ci.org/shopsys/phpstorm-inspect/branches) must be passing (your branch will be automatically built after push).
